...
| 6 Published dashboard | **Done.** **DE C1 E-Commerce Sales Dashboard** rendered **manually** in the Databricks SQL UI. Not generated by Cursor. |
...
| 13 Repository closeout | **This increment.** Docs/evidence only. Do not change pipeline/Gold/dashboard SQL. Do not push until asked. |
...
**Do not regenerate sample data unless asked. Do not modify pipeline logic, Gold SQL, or dashboard SQL. Do not modify the published Databricks dashboard. Do not push until asked. Do not treat exploratory notebook cells as the official Databricks process. Do not claim Cursor generated the visual dashboard.**
